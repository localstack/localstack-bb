...
class TransferApi:
    ...
    def create_access(self, context: RequestContext, role: Role, server_id: ServerId, external_id: ExternalId, home_directory: HomeDirectory | None = None, home_directory_type: HomeDirectoryType | None = None, home_directory_mappings: HomeDirectoryMappings | None = None, policy: Policy | None = None, posix_profile: PosixProfile | None = None, **kwargs) -> CreateAccessResponse:
...
:raises ResourceExistsException:
    ...
    def create_agreement(self, context: RequestContext, server_id: ServerId, local_profile_id: ProfileId, partner_profile_id: ProfileId, access_role: Role, description: Description | None = None, base_directory: HomeDirectory | None = None, status: AgreementStatusType | None = None, tags: Tags | None = None, preserve_filename: PreserveFilenameType | None = None, enforce_message_signing: EnforceMessageSigningType | None = None, custom_directories: CustomDirectoriesType | None = None, **kwargs) -> CreateAgreementResponse:
...
:raises ResourceExistsException:
    ...
    def create_connector(self, context: RequestContext, access_role: Role, url: Url | None = None, as2_config: As2ConnectorConfig | None = None, logging_role: Role | None = None, tags: Tags | None = None, sftp_config: SftpConnectorConfig | None = None, security_policy_name: ConnectorSecurityPolicyName | None = None, egress_config: ConnectorEgressConfig | None = None, **kwargs) -> CreateConnectorResponse:
...
:raises ResourceExistsException:
    ...
    def create_profile(self, context: RequestContext, as2_id: As2Id, profile_type: ProfileType, certificate_ids: CertificateIds | None = None, tags: Tags | None = None, **kwargs) -> CreateProfileResponse:
...
:raises ServiceUnavailableException:
    ...
    def create_server(self, context: RequestContext, certificate: Certificate | None = None, domain: Domain | None = None, endpoint_details: EndpointDetails | None = None, endpoint_type: EndpointType | None = None, host_key: HostKey | None = None, identity_provider_details: IdentityProviderDetails | None = None, identity_provider_type: IdentityProviderType | None = None, logging_role: NullableRole | None = None, post_authentication_login_banner: PostAuthenticationLoginBanner | None = None, pre_authentication_login_banner: PreAuthenticationLoginBanner | None = None, protocols: Protocols | None = None, protocol_details: ProtocolDetails | None = None, security_policy_name: SecurityPolicyName | None = None, tags: Tags | None = None, workflow_details: WorkflowDetails | None = None, structured_log_destinations: StructuredLogDestinations | None = None, s3_storage_options: S3StorageOptions | None = None, ip_address_type: IpAddressType | None = None, **kwargs) -> CreateServerResponse:
...
:raises AccessDeniedException:
    ...
    @handler("CreateUser")
    def create_user(self, context: RequestContext, role: Role, server_id: ServerId, user_name: UserName, home_directory: HomeDirectory | None = None, home_directory_type: HomeDirectoryType | None = None, home_directory_mappings: HomeDirectoryMappings | None = None, policy: Policy | None = None, posix_profile: PosixProfile | None = None, ssh_public_key_body: SshPublicKeyBody | None = None, tags: Tags | None = None, **kwargs) -> CreateUserResponse:
...
:raises ResourceExistsException:
    ...
    def create_web_app(self, context: RequestContext, identity_provider_details: WebAppIdentityProviderDetails, access_endpoint: WebAppAccessEndpoint | None = None, web_app_units: WebAppUnits | None = None, tags: Tags | None = None, web_app_endpoint_policy: WebAppEndpointPolicy | None = None, endpoint_details: WebAppEndpointDetails | None = None, **kwargs) -> CreateWebAppResponse:
...
:raises AccessDeniedException:
    ...
    def create_workflow(self, context: RequestContext, steps: WorkflowSteps, description: WorkflowDescription | None = None, on_exception_steps: WorkflowSteps | None = None, tags: Tags | None = None, **kwargs) -> CreateWorkflowResponse:
...
:raises AccessDeniedException:
    ...
    def delete_access(self, context: RequestContext, server_id: ServerId, external_id: ExternalId, **kwargs) -> None:
...
:raises ServiceUnavailableException:
    ...
    def delete_agreement(self, context: RequestContext, agreement_id: AgreementId, server_id: ServerId, **kwargs) -> None:
...
:raises ServiceUnavailableException:
    ...
    def delete_certificate(self, context: RequestContext, certificate_id: CertificateId, **kwargs) -> None:
...
:raises ServiceUnavailableException:
    ...
    def delete_connector(self, context: RequestContext, connector_id: ConnectorId, **kwargs) -> None:
...
:raises ServiceUnavailableException:
    ...
    def delete_host_key(self, context: RequestContext, server_id: ServerId, host_key_id: HostKeyId, **kwargs) -> None:
...
:raises AccessDeniedException:
    ...
    def delete_ssh_public_key(self, context: RequestContext, server_id: ServerId, ssh_public_key_id: SshPublicKeyId, user_name: UserName, **kwargs) -> None:
...
:raises ServiceUnavailableException:
    ...
    @handler("DeleteUser")
    def delete_user(self, context: RequestContext, server_id: ServerId, user_name: UserName, **kwargs) -> None:
...
:raises AccessDeniedException:
    ...
    def delete_web_app_customization(self, context: RequestContext, web_app_id: WebAppId, **kwargs) -> None:
...
:raises AccessDeniedException:
    ...
    def describe_access(self, context: RequestContext, server_id: ServerId, external_id: ExternalId, **kwargs) -> DescribeAccessResponse:
...
:raises ServiceUnavailableException:
    ...
    def describe_agreement(self, context: RequestContext, agreement_id: AgreementId, server_id: ServerId, **kwargs) -> DescribeAgreementResponse:
...
:raises ServiceUnavailableException:
    ...
    def describe_certificate(self, context: RequestContext, certificate_id: CertificateId, **kwargs) -> DescribeCertificateResponse:
...
:raises ServiceUnavailableException:
    ...
    def describe_connector(self, context: RequestContext, connector_id: ConnectorId, **kwargs) -> DescribeConnectorResponse:
...
:raises ServiceUnavailableException:
    ...
    def describe_execution(self, context: RequestContext, execution_id: ExecutionId, workflow_id: WorkflowId, **kwargs) -> DescribeExecutionResponse:
...
:raises ServiceUnavailableException:
    ...
    def describe_host_key(self, context: RequestContext, server_id: ServerId, host_key_id: HostKeyId, **kwargs) -> DescribeHostKeyResponse:
...
:raises ServiceUnavailableException:
    ...
    def describe_profile(self, context: RequestContext, profile_id: ProfileId, **kwargs) -> DescribeProfileResponse:
...
:raises ServiceUnavailableException:
    ...
    def describe_security_policy(self, context: RequestContext, security_policy_name: SecurityPolicyName, **kwargs) -> DescribeSecurityPolicyResponse:
...
:raises ServiceUnavailableException:
    ...
    def describe_server(self, context: RequestContext, server_id: ServerId, **kwargs) -> DescribeServerResponse:
...
:raises ServiceUnavailableException:
    ...
    def describe_user(self, context: RequestContext, server_id: ServerId, user_name: UserName, **kwargs) -> DescribeUserResponse:
...
:raises ServiceUnavailableException:
    ...
    def describe_web_app(self, context: RequestContext, web_app_id: WebAppId, **kwargs) -> DescribeWebAppResponse:
...
:raises AccessDeniedException:
    ...
    def describe_web_app_customization(self, context: RequestContext, web_app_id: WebAppId, **kwargs) -> DescribeWebAppCustomizationResponse:
...
:raises AccessDeniedException:
    ...
    def describe_workflow(self, context: RequestContext, workflow_id: WorkflowId, **kwargs) -> DescribeWorkflowResponse:
...
:raises ServiceUnavailableException:
    ...
    def import_certificate(self, context: RequestContext, usage: CertificateUsageType, certificate: CertificateBodyType, certificate_chain: CertificateChainType | None = None, private_key: PrivateKeyType | None = None, active_date: CertDate | None = None, inactive_date: CertDate | None = None, description: Description | None = None, tags: Tags | None = None, **kwargs) -> ImportCertificateResponse:
...
:raises ServiceUnavailableException:
    ...
    def import_host_key(self, context: RequestContext, server_id: ServerId, host_key_body: HostKey, description: HostKeyDescription | None = None, tags: Tags | None = None, **kwargs) -> ImportHostKeyResponse:
...
:raises ResourceExistsException:
    ...
    def import_ssh_public_key(self, context: RequestContext, server_id: ServerId, ssh_public_key_body: SshPublicKeyBody, user_name: UserName, **kwargs) -> ImportSshPublicKeyResponse:
...
:raises ResourceExistsException:
    ...
    def list_accesses(self, context: RequestContext, server_id: ServerId, max_results: MaxResults | None = None, next_token: NextToken | None = None, **kwargs) -> ListAccessesResponse:
...
:raises InvalidNextTokenException:
    ...
    def list_agreements(self, context: RequestContext, server_id: ServerId, max_results: MaxResults | None = None, next_token: NextToken | None = None, **kwargs) -> ListAgreementsResponse:
...
:raises InvalidNextTokenException:
    ...
    def list_certificates(self, context: RequestContext, max_results: MaxResults | None = None, next_token: NextToken | None = None, **kwargs) -> ListCertificatesResponse:
...
:raises InvalidNextTokenException:
    ...
    def list_connectors(self, context: RequestContext, max_results: MaxResults | None = None, next_token: NextToken | None = None, **kwargs) -> ListConnectorsResponse:
...
:raises InvalidNextTokenException:
    ...
    def list_executions(self, context: RequestContext, workflow_id: WorkflowId, max_results: MaxResults | None = None, next_token: NextToken | None = None, **kwargs) -> ListExecutionsResponse:
...
:raises InvalidNextTokenException:
    ...
    def list_file_transfer_results(self, context: RequestContext, connector_id: ConnectorId, transfer_id: TransferId, next_token: NextToken | None = None, max_results: MaxResults | None = None, **kwargs) -> ListFileTransferResultsResponse:
...
:raises ServiceUnavailableException:
    ...
    def list_host_keys(self, context: RequestContext, server_id: ServerId, max_results: MaxResults | None = None, next_token: NextToken | None = None, **kwargs) -> ListHostKeysResponse:
...
:raises InvalidNextTokenException:
    ...
    def list_profiles(self, context: RequestContext, max_results: MaxResults | None = None, next_token: NextToken | None = None, profile_type: ProfileType | None = None, **kwargs) -> ListProfilesResponse:
...
:raises InvalidNextTokenException:
    ...
    def list_security_policies(self, context: RequestContext, max_results: MaxResults | None = None, next_token: NextToken | None = None, **kwargs) -> ListSecurityPoliciesResponse:
...
:raises InvalidNextTokenException:
    ...
    @handler("ListServers")
    def list_servers(self, context: RequestContext, max_results: MaxResults | None = None, next_token: NextToken | None = None, **kwargs) -> ListServersResponse:
...
:raises InvalidNextTokenException:
    ...
    def list_tags_for_resource(self, context: RequestContext, arn: Arn, max_results: MaxResults | None = None, next_token: NextToken | None = None, **kwargs) -> ListTagsForResourceResponse:
...
:raises InvalidNextTokenException:
    ...
    @handler("ListUsers")
    def list_users(self, context: RequestContext, server_id: ServerId, max_results: MaxResults | None = None, next_token: NextToken | None = None, **kwargs) -> ListUsersResponse:
...
:raises InvalidNextTokenException:
    ...
    @handler("ListWebApps")
    def list_web_apps(self, context: RequestContext, max_results: MaxResults | None = None, next_token: NextToken | None = None, **kwargs) -> ListWebAppsResponse:
...
:raises InvalidNextTokenException:
    ...
    def list_workflows(self, context: RequestContext, max_results: MaxResults | None = None, next_token: NextToken | None = None, **kwargs) -> ListWorkflowsResponse:
...
:raises InvalidNextTokenException:
    ...
    def send_workflow_step_state(self, context: RequestContext, workflow_id: WorkflowId, execution_id: ExecutionId, token: CallbackToken, status: CustomStepStatus, **kwargs) -> SendWorkflowStepStateResponse:
...
:raises AccessDeniedException:
    ...
    def start_directory_listing(self, context: RequestContext, connector_id: ConnectorId, remote_directory_path: FilePath, output_directory_path: FilePath, max_items: MaxItems | None = None, **kwargs) -> StartDirectoryListingResponse:
...
:raises ServiceUnavailableException:
    ...
    def start_file_transfer(self, context: RequestContext, connector_id: ConnectorId, send_file_paths: FilePaths | None = None, retrieve_file_paths: FilePaths | None = None, local_directory_path: FilePath | None = None, remote_directory_path: FilePath | None = None, custom_http_headers: CustomHttpHeaders | None = None, **kwargs) -> StartFileTransferResponse:
...
:raises ServiceUnavailableException:
    ...
    def start_remote_delete(self, context: RequestContext, connector_id: ConnectorId, delete_path: FilePath, **kwargs) -> StartRemoteDeleteResponse:
...
:raises ServiceUnavailableException:
    ...
    def start_remote_move(self, context: RequestContext, connector_id: ConnectorId, source_path: FilePath, target_path: FilePath, **kwargs) -> StartRemoteMoveResponse:
...
:raises ServiceUnavailableException:
    ...
    def test_connection(self, context: RequestContext, connector_id: ConnectorId, **kwargs) -> TestConnectionResponse:
...
:raises ServiceUnavailableException:
    ...
    def test_identity_provider(self, context: RequestContext, server_id: ServerId, user_name: UserName, server_protocol: Protocol | None = None, source_ip: SourceIp | None = None, user_password: UserPassword | None = None, **kwargs) -> TestIdentityProviderResponse:
...
:raises ServiceUnavailableException:
    ...
    def untag_resource(self, context: RequestContext, arn: Arn, tag_keys: TagKeys, **kwargs) -> None:
...
:raises ServiceUnavailableException:
    ...
    def update_access(self, context: RequestContext, server_id: ServerId, external_id: ExternalId, home_directory: HomeDirectory | None = None, home_directory_type: HomeDirectoryType | None = None, home_directory_mappings: HomeDirectoryMappings | None = None, policy: Policy | None = None, posix_profile: PosixProfile | None = None, role: Role | None = None, **kwargs) -> UpdateAccessResponse:
...
:raises ResourceExistsException:
    ...
    def update_agreement(self, context: RequestContext, agreement_id: AgreementId, server_id: ServerId, description: Description | None = None, status: AgreementStatusType | None = None, local_profile_id: ProfileId | None = None, partner_profile_id: ProfileId | None = None, base_directory: HomeDirectory | None = None, access_role: Role | None = None, preserve_filename: PreserveFilenameType | None = None, enforce_message_signing: EnforceMessageSigningType | None = None, custom_directories: CustomDirectoriesType | None = None, **kwargs) -> UpdateAgreementResponse:
...
:raises ResourceExistsException:
    ...
    def update_certificate(self, context: RequestContext, certificate_id: CertificateId, active_date: CertDate | None = None, inactive_date: CertDate | None = None, description: Description | None = None, **kwargs) -> UpdateCertificateResponse:
...
:raises ServiceUnavailableException:
    ...
    def update_connector(self, context: RequestContext, connector_id: ConnectorId, url: Url | None = None, as2_config: As2ConnectorConfig | None = None, access_role: Role | None = None, logging_role: Role | None = None, sftp_config: SftpConnectorConfig | None = None, security_policy_name: ConnectorSecurityPolicyName | None = None, egress_config: UpdateConnectorEgressConfig | None = None, **kwargs) -> UpdateConnectorResponse:
...
:raises ResourceExistsException:
    ...
    def update_host_key(self, context: RequestContext, server_id: ServerId, host_key_id: HostKeyId, description: HostKeyDescription, **kwargs) -> UpdateHostKeyResponse:
...
:raises ServiceUnavailableException:
    ...
    def update_profile(self, context: RequestContext, profile_id: ProfileId, certificate_ids: CertificateIds | None = None, **kwargs) -> UpdateProfileResponse:
...
:raises ServiceUnavailableException:
    ...
    def update_server(self, context: RequestContext, server_id: ServerId, certificate: Certificate | None = None, protocol_details: ProtocolDetails | None = None, endpoint_details: EndpointDetails | None = None, endpoint_type: EndpointType | None = None, host_key: HostKey | None = None, identity_provider_details: IdentityProviderDetails | None = None, logging_role: NullableRole | None = None, post_authentication_login_banner: PostAuthenticationLoginBanner | None = None, pre_authentication_login_banner: PreAuthenticationLoginBanner | None = None, protocols: Protocols | None = None, security_policy_name: SecurityPolicyName | None = None, workflow_details: WorkflowDetails | None = None, structured_log_destinations: StructuredLogDestinations | None = None, s3_storage_options: S3StorageOptions | None = None, ip_address_type: IpAddressType | None = None, identity_provider_type: IdentityProviderType | None = None, **kwargs) -> UpdateServerResponse:
...
:raises AccessDeniedException:
    ...
    @handler("UpdateUser")
    def update_user(self, context: RequestContext, server_id: ServerId, user_name: UserName, home_directory: HomeDirectory | None = None, home_directory_type: HomeDirectoryType | None = None, home_directory_mappings: HomeDirectoryMappings | None = None, policy: Policy | None = None, posix_profile: PosixProfile | None = None, role: Role | None = None, **kwargs) -> UpdateUserResponse:
...
:raises ServiceUnavailableException:
    ...
    def update_web_app(self, context: RequestContext, web_app_id: WebAppId, identity_provider_details: UpdateWebAppIdentityProviderDetails | None = None, access_endpoint: WebAppAccessEndpoint | None = None, web_app_units: WebAppUnits | None = None, endpoint_details: UpdateWebAppEndpointDetails | None = None, **kwargs) -> UpdateWebAppResponse:
...
:raises AccessDeniedException:
    ...
    def update_web_app_customization(self, context: RequestContext, web_app_id: WebAppId, title: WebAppTitle | None = None, logo_file: WebAppLogoFile | None = None, favicon_file: WebAppFaviconFile | None = None, **kwargs) -> UpdateWebAppCustomizationResponse:
