...
def legacy_s3_rules(request: Request) -> ServiceModelIdentifier | None:
    """
    Legacy S3 routing heuristics. No service implementations are registered by default;
    downstream S3 provider packages should re-implement these rules via their own routing hooks.
    """
    return None
