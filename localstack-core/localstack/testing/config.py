...
SECONDARY_TEST_AWS_ACCOUNT_ID = (
    os.getenv("SECONDARY_TEST_AWS_ACCOUNT_ID") or "000000000002"
)
SECONDARY_TEST_AWS_ACCESS_KEY_ID = (
    os.getenv("SECONDARY_TEST_AWS_ACCESS_KEY_ID") or "000000000002"
)
SECONDARY_TEST_AWS_SECRET_ACCESS_KEY = (
    os.getenv("SECONDARY_TEST_AWS_SECRET_ACCESS_KEY") or "test2"
)
SECONDARY_TEST_AWS_SESSION_TOKEN = os.getenv("SECONDARY_TEST_AWS_SESSION_TOKEN")
SECONDARY_TEST_AWS_REGION_NAME = (
    os.getenv("SECONDARY_TEST_AWS_REGION_NAME") or "ap-southeast-1"
)
